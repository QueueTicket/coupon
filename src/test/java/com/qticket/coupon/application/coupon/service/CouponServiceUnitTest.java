...
class CouponServiceUnitTest {
    ...
    void 쿠폰_생성_성공_단위_테스트() {
        ...
        // given
        CouponRepository couponRepository = new FakeRepository();
    ...
    void 쿠폰_삭제_성공_단위_테스트() {
        ...
        // when
        CouponDeleteResponseDto couponDeleteResponse = couponService.delete(1L, "ADMIN", new CouponDeleteRequestDto(couponCreateResponse.getCouponId()));
